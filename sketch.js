...
function preload () {
  images_img=loadImage("images.png");
  house_img=loadImage("HOUSE.jpg");
  dimond_img=loadImage("DIMOND.jpg");
  laser_img=loadImage("LASER 1.png");
  sec1_img=loadImage("SEC 1.jpg");
  sec2_img=loadImage("SEC2.jpg");
  thief_img=loadImage("THIEF.jpg");
  garden_img=loadImage("garden.jpg");
}
